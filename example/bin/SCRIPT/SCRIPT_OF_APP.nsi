...
!define PRODUCT_TITLE "my-App-guiExample"
!define PRODUCT_FOLDER "TEST_OF_Windows_Installer"
!define PRODUCT_FILE "guiExample"
...
!define AFTER_INSTALLATION_URL "https://aka.ms/vs/16/release/vc_redist.x64.exe" # open browser and download redistributable, required for OF
